...
export const CHAPTER_INTROS: ChapterIntroConfig[] = [
  {
    ...
    subtitle: "雾原前线",
    storyParagraphs: [
      "雾原营火仍在风里摇晃，兽群已穿过浅沼与草脊，逼近失守已久的前线木寨。",
      "你必须撕开白猿王布下的围猎圈，让第一道封印纹重新发亮，稳住整条北境战线。",
    ],
    ctaLabel: "踏入雾原前线",
    palette: {
      background:
  ...
  },
  {
    ...
    subtitle: "裂石营地",
    storyParagraphs: [
      "草原防线被你撕开后，敌军迅速退入矿道深处，裂岩山壁之间回荡着急促战鼓。",
      "夺回裂石营地的高台烽火，重启第二道封印纹，补给线才能再次穿过荒境腹地。",
    ],
    ctaLabel: "踏入裂石营地",
    palette: {
      background:
  ...
  },
  {
    ...
    subtitle: "古堡回廊",
    storyParagraphs: [
      "月蚀提前压向断垣古堡，回廊与血宴大厅在黑潮里彼此重叠，阴影中尽是巡猎低鸣。",
      "只有夺回深处被掩埋的圣痕，第三道纹阵才会再度发亮，夜行眷属的封锁也会松动。",
    ],
    ctaLabel: "踏入古堡回廊",
    palette: {
      background:
  ...
  },
  {
    ...
    subtitle: "高空裂谷",
    storyParagraphs: [
      "战线被迫抬升到云海之上，雷暴与孢雾昼夜撕扯高空裂谷，断桥尽头杀机四伏。",
      "稳住风暴中央的第四道封印纹，让高空要道重新连成一线，王庭入口才会显形。",
    ],
    ctaLabel: "踏入高空裂谷",
    palette: {
      background:
  ...
  },
  {
    ...
    subtitle: "终焉王庭",
    storyParagraphs: [
      "风暴龙脊失守后，深井尽头的王庭终于显形，亡骸祭坛一路燃着不灭的冥火。",
      "在这里闭合最后一道封印纹，终结焚冠冥皇的统治，这场远征才算真正走到尽头。",
    ],
    ctaLabel: "踏入终焉王庭",
    palette: {
      background:
